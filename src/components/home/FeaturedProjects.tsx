...
const featuredProjects: Project[] = [
  {
    id: "1",
    title: "AI Project Alpha",
    description: "An intelligent machine learning system for...",
  ...
  },
  {
    ...
    description: "Interactive visualization of neural network structures...",
    thumbnailUrl: "/images/projects/project2.jpg",
    featured: true,
    githubUrl: "https://github.com/yourusername/project2",
    tags: ["Visualization", "React", "WebGL"],
  },
  {
    id: "3",
    ...
    tags: ["Dashboard", "Analytics", "Docker"],
  },
];
